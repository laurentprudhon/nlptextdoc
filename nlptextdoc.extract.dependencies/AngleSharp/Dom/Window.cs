namespace AngleSharp.Dom
{
    ...
    sealed class Window : EventTarget, IWindow
    {
        ...
        // When the document is read-only, several properties can be cached
        private StyleCollection styleRulesCache = null;
        private Dictionary<IElement, CssStyleDeclaration> elementsStyleCache = null;
        ...
        public object GetComputedStyle(IElement htmlElement)
        {
