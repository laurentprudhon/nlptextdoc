namespace AngleSharp.Dom.Css
{
    ...
    sealed class CssRuleList : ICssRuleList
    {
        ...
        readonly Boolean _filterDisplayAndVisibilityOnly;

        #endregion

        #region ctor

        internal CssRuleList(CssNode parent, Boolean filterDisplayAndVisibilityOnly)
        {
            _parent = parent;
            _filterDisplayAndVisibilityOnly = filterDisplayAndVisibilityOnly;
        }
