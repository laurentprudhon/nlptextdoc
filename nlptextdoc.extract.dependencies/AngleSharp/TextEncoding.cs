namespace AngleSharp
{
    ...
    public static class TextEncoding
    {
        static TextEncoding()
        {
            // In .Net Core, code pages character sets are provided in a separate Nuget package :
            ...
            Utf32Le = GetEncoding("UTF-32LE");
            Utf32Be = GetEncoding("UTF-32BE");
            Gb18030 = GetEncoding("GB18030");
            Big5 = GetEncoding("big5");
            Windows874 = GetEncoding("windows-874");
            Windows1250 = GetEncoding("windows-1250");
            Windows1251 = GetEncoding("windows-1251");
            Windows1252 = GetEncoding("windows-1252");
            Windows1253 = GetEncoding("windows-1253");
            Windows1254 = GetEncoding("windows-1254");
            Windows1255 = GetEncoding("windows-1255");
            Windows1256 = GetEncoding("windows-1256");
            Windows1257 = GetEncoding("windows-1257");
            Windows1258 = GetEncoding("windows-1258");
            Latin2 = GetEncoding("iso-8859-2");
            Latin3 = GetEncoding("iso-8859-3");
            Latin4 = GetEncoding("iso-8859-4");
            Latin5 = GetEncoding("iso-8859-5");
            Latin13 = GetEncoding("iso-8859-13");
            UsAscii = GetEncoding("us-ascii");
            Korean = GetEncoding("ks_c_5601-1987");
